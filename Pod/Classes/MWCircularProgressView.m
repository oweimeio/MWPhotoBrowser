...
@interface MWCircularProgressLayer : CALayer
...
@implementation MWCircularProgressLayer
...
@interface MWCircularProgressView ()

@end

@implementation MWCircularProgressView

+ (void) initialize
{
    if (self != [MWCircularProgressView class])
        return;
...
+ (Class)layerClass
{
    return [MWCircularProgressLayer class];
}

- (MWCircularProgressLayer *)circularProgressLayer
{
    return (MWCircularProgressLayer *)self.layer;
}
